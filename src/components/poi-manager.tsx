...
export function POIManager({ accessToken, onFlyTo }: POIManagerProps) {
  ...
  const handleLocationSelect = (coords: Coordinates, name: string, full_address: string) => {
    setSelectedLocation({
      coordinates: coords,
