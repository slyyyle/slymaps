...
import type { Coordinates, PointOfInterest } from './core';
import type { ObaArrivalDeparture, ObaVehicleLocation, CurrentOBARouteDisplayData } from './oba';
